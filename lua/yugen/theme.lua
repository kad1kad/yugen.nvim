...
function M.get(config)
  ...
  theme = {
    ...
    DiffAdd = { bg = p.color600, },
    DiffChange = { fg = p.color200, bg = p.color600 },
    DiffDelete = { bg = p.color600 },
    DiffText = { bg = p.color600 },
    ...
    MatchParen = { fg = p.color200, bg = p.color600 },
    ...
    NvimInternalError = { fg = p.error, bg = p.color600 },
    Pmenu = { fg = p.color200, bg = p.color600 },
    PmenuSbar = { bg = p.colo600 },
    ...
    RedrawDebugRecompose = { fg = p.error, bg = p.color600 },
    ...
    SignColumn = { fg = p.color200, bg = p.color600 },
    StatusLine = { fg = p.color200, bg = p.color600 },
    StatusLineNC = { fg = p.color200, bg = p.color600 },
